...
const EditarProductos=()=>{
    ...
    const modificarProducto= async(event)=>{
        ...
        try {
            ...
            const respuesta =await ProductosServicios.modificarProducto(id,productoMofificado);
            console.log(respuesta);
            ...
            <main>
                ...
                <section className="main-container">
                    ...
                    <label for="categoria" className="main-input">
                        ...
                        <button type="submit" className="payment-button button button-save" onClick={modificarProducto}>Guardar</button>
